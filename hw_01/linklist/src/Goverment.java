...
public class Goverment {
    ...
    public static Goverment greaterTreasury(Goverment a, Goverment b) {
    ...
    public class Explorer {
        public void doStuff(Goverment a, Goverment b) {
            Goverment favorite = Goverment.greaterTreasury(a, b);
